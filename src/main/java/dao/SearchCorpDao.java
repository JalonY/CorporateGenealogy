 ...
 * @date: 2018/4/9
 */
public interface SearchCorpDao {
    ...
    List<TCorp> getListCorpByDate(@Param("new_before_date")String new_before_date, @Param("new_after_date")String new_after_date); //根据日期获取相关企业
    ...
    String advancedSearch(@Param("top_inputName")String top_inputName, @Param("top_inputAddress")String top_inputAddress, @Param("top_capiStart")String top_capiStart,
                          @Param("top_capiEnd")String top_capiEnd, @Param("top_manName")String top_manName, @Param("top_stockName")String top_stockName,
                          @Param("top_inputScope")String top_inputScope); //高级查询企业
    ...
    List<TCorp> getSomeCorpName(@Param("i")int i,@Param("corpName")String corpName);  //两种集合中数量不足进行补充
    ...
    void deleteCollect(@Param("userId")int userId,@Param("corpId")int corpId);  //根据用户Id与收藏企业ID删除收藏企业

    void deleteAttention(@Param("userId")int userId,@Param("corpId")int corpId);  //根据用户Id与关注企业ID删除关注企业
